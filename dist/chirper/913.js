"use strict";
(self["webpackChunkchirper"] = self["webpackChunkchirper"] || []).push([[913,773,595],{
...
const buttonClasses = (0,generateUtilityClasses/* default */.Z)('MuiButton', ['root', 'active', 'disabled', 'focusVisible']);
...
var useForkRef = __webpack_require__(3703);
...
function useButton(parameters = {}) {
  ...
  const [active, setActive] = index_js_eager_.useState(false);
  const {
    isFocusVisibleRef,
  ...
  const [hostElementName, setHostElementName] = index_js_eager_.useState('');
  ...
  const updateHostElementName = index_js_eager_.useCallback(instance => {
    var _instance$tagName;
    setHostElementName((_instance$tagName = instance == null ? void 0 : instance.tagName) != null ? _instance$tagName : '');
  }, []);
  const handleRef = (0,useForkRef/* default */.Z)(updateHostElementName, externalRef, focusVisibleRef, buttonRef);
  const buttonProps = {};
...
const ClassNameConfiguratorContext = /*#__PURE__*/index_js_eager_.createContext(defaultContextValue);
/**
...
function useClassNamesOverride(generateUtilityClass) {
  ...
  } = index_js_eager_.useContext(ClassNameConfiguratorContext);
  return slot => {
...
const useUtilityClasses = ownerState => {
  ...
  return (0,composeClasses/* default */.Z)(slots, useClassNamesOverride(getButtonUtilityClass));
};
/**
 ...
 */
const Button = /*#__PURE__*/index_js_eager_.forwardRef(function Button(props, forwardedRef) {
  var _slots$root;
  const {
      action,
      children,
