"use strict";
(self["webpackChunkchirper"] = self["webpackChunkchirper"] || []).push([[884],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "batch": () => (/* reexport */ react_dom_index_js_eager_.unstable_batchedUpdates),
...
// EXTERNAL MODULE: consume shared module (default) react@^16.8.3 || ^17 || ^18 (singleton) (fallback: ../node_modules/react/index.js) (eager)
var index_js_eager_ = __webpack_require__(5528);
var index_js_eager_default = /*#__PURE__*/__webpack_require__.n(index_js_eager_);
;// CONCATENATED MODULE: ../node_modules/react-redux/es/components/Context.js

var ReactReduxContext = /*#__PURE__*/index_js_eager_default().createContext(null);
...
function Provider(_ref) {
  ...
  var contextValue = (0,index_js_eager_.useMemo)(function () {
  ...
  var previousState = (0,index_js_eager_.useMemo)(function () {
...
_ref) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    var usePureOnlyMemo = pure ? index_js_eager_.useMemo : function (callback) {
      return callback();
    };

    function ConnectFunction(props) {
      var _useMemo = (0,index_js_eager_.useMemo)(function () {
      ...
      var ContextToUse = (0,index_js_eager_.useMemo)(function () {
        // Users may optionally pass in a custom context instance to use instead of our ReactReduxContext.
        // Memoize the check that determines which context instance we should use.
        return propsContext && propsContext.Consumer && (0,react_is.isContextConsumer)( /*#__PURE__*/index_js_eager_default().createElement(propsContext.Consumer, null)) ? propsContext : Context;
      }, [propsContext, Context]); // Retrieve the store and ancestor subscription via context, if available

      var contextValue = (0,index_js_eager_.useContext)(ContextToUse); // The store _must_ exist as either a prop or in context.
      ...
      var childPropsSelector = (0,index_js_eager_.useMemo)(function () {
        // The child props selector needs the store reference as an input.
        // Re-create this selector whenever the store changes.
        return createChildSelector(store);
      }, [store]);

      var _useMemo2 = (0,index_js_eager_.useMemo)(function () {
      ...
      var overriddenContextValue = (0,index_js_eager_.useMemo)(function () {
      ...
      var _useReducer = (0,index_js_eager_.useReducer)(storeStateUpdatesReducer, EMPTY_ARRAY, initStateUpdates),
      ...
      var lastChildProps = (0,index_js_eager_.useRef)();
      var lastWrapperProps = (0,index_js_eager_.useRef)(wrapperProps);
      var childPropsFromStoreUpdate = (0,index_js_eager_.useRef)();
      var renderIsScheduled = (0,index_js_eager_.useRef)(false);
      ...
      var renderedWrappedComponent = (0,index_js_eager_.useMemo)(function () {
        return /*#__PURE__*/index_js_eager_default().createElement(WrappedComponent, (0,esm_extends/* default */.Z)({}, actualChildProps, {
          ref: reactReduxForwardedRef
        }));
      }, [reactReduxForwardedRef, WrappedComponent, actualChildProps]); // If React sees the exact same element reference as last time, it bails out of re-rendering
      // that child, same as if it was wrapped in React.memo() or returned false from shouldComponentUpdate.

      var renderedChild = (0,index_js_eager_.useMemo)(function () {
        if (shouldHandleStateChanges) {
          // If this component is subscribed to store updates, we need to pass its own
          // subscription instance down to our descendants. That means rendering the same
          // Context instance, and putting a different value into the context.
          return /*#__PURE__*/index_js_eager_default().createElement(ContextToUse.Provider, {
    ...
    var Connect = pure ? index_js_eager_default().memo(ConnectFunction) : ConnectFunction;
    Connect.WrappedComponent = WrappedComponent;
    Connect.displayName = ConnectFunction.displayName = displayName;

    if (forwardRef) {
      var forwarded = index_js_eager_default().forwardRef(function forwardConnectRef(props, ref) {
        return /*#__PURE__*/index_js_eager_default().createElement(Connect, (0,esm_extends/* default */.Z)({}, props, {
...
function useReduxContext_useReduxContext() {
  var contextValue = (0,index_js_eager_.useContext)(ReactReduxContext);
...
function createStoreHook(context) {
  ...
  var useReduxContext = context === ReactReduxContext ? useReduxContext_useReduxContext : function () {
    return (0,index_js_eager_.useContext)(context);
  };
...
function useSelectorWithStoreAndSubscription(selector, equalityFn, store, contextSub) {
  var _useReducer = (0,index_js_eager_.useReducer)(function (s) {
    return s + 1;
  }, 0),
      forceRender = _useReducer[1];

  var subscription = (0,index_js_eager_.useMemo)(function () {
    return createSubscription(store, contextSub);
  }, [store, contextSub]);
  var latestSubscriptionCallbackError = (0,index_js_eager_.useRef)();
  var latestSelector = (0,index_js_eager_.useRef)();
  var latestStoreState = (0,index_js_eager_.useRef)();
  var latestSelectedState = (0,index_js_eager_.useRef)();
...
function createSelectorHook(context) {
  ...
  return function useSelector(selector, equalityFn) {
    ...
    (0,index_js_eager_.useDebugValue)(selectedState);
    return selectedState;
  };
}
/**
...
var react_dom_index_js_eager_ = __webpack_require__(662);
...
setBatch(react_dom_index_js_eager_.unstable_batchedUpdates);
